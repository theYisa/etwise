...
import { GraduationCap, BookCopy, LucideCircuitBoard, LucideAlignVerticalJustifyCenter, X, LineChart, Cpu, ArrowUpRight, CheckCircle2, Zap, Film, Database } from 'lucide-react';
  ...
  const osServicos = [
    {
      ...
      features: ["Beautiful UI and Designs", "Strong Search Engine Optimisation (SEO)", "Run apps on Multi-Língua [ EN - PT - FR ]", "Academia and Business Centred Apps"]
    },
    {
      id: "srv-2",
    ...
    <div className='full-body'>
          ...
          <section className='direita'>
            ...
            <div className="yisa-info to-right">
              ...
              <div className="skill the-right">
                ...
                <div className='skill-line'></div>
                <ul className="skill-bullet">
                  <li><img src='flutter.png' alt="Flutter"/> Flutter (Cross Platform Mobile Apps)</li>
                  <li><img src='react.png' alt="React"/> React (JavaScript)</li>
                  <li><img src='nextjs.png' alt="NextJS"/> Next JS </li>
                  <li><img src='node.png' alt="NodeJS"/> Node JS </li>
                  <li><img src='mongodb.png' alt="MongoDB"/> MongoDB </li>
                  <li><img src='seo.png' alt="SEO"/> SEO Optimization</li>
                </ul>
              </div>
            </div>
          </section>
        ...
        {cvOpen && (
          <div className='full-modal'>
            <div className='cv-modal'>
              ...
              <iframe src='/cv.pdf' className='cv-frame' title="CV File" />
            </div>
          </div>
        )}
      </div>
      ...
      <div className="body3">
              ...
              <div key={e.id} className="each-card">
                ...
                <div className="card-stacks">
                  ...
                  {e.features.map((feat, i) => ( 
                    <div key={i} className="stacks-item"> 
                      <CheckCircle2 size={14} className="item-icon" /> <span>{feat}</span> 
                    </div> 
                  ))}
                </div>
              </div>
        ...
        <section className="lab">
          ...
          <div className='arrow arrow-right' role='button' onClick={(w) => {
            const container = w.currentTarget.previousSibling;
            container.scrollBy({ left: container.clientWidth, behavior: 'smooth' });
          }}></div>

          <div className='arrow arrow-left' role='button' onClick={(w) => {
